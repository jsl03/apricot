...
def run_map(
        ...
        init_method: typing.Union[dict, str, int] = 'random',
        algorithm: str = 'Newton',
        restarts: int = 10,
        max_iter: int = 250,
        seed: typing.Optional[int] = None,
) -> typing.Union[np.ndarray, dict]:
    """ Maximum a-posteriori probability estimation via numerical optimisation
    ...
    logger.debug(
        'Initialising MAP optimisation routine with: \n{0}'.format(
            log_options(opts)
        )
    )
